...
public class MenuCommand implements Command {
    ...
    public void handleCommand(MessageCreatedUpdate update, MaxClient client) {
        ...
        buttonRow1.add(
                new CallbackButton(CallbackName.SHOP.getCallbackName() + ":0", StringConstants.SHOP_BUTTON.getValue()));
        buttonGrid.add(buttonRow1);
        List<Button> buttonRow2 = new ArrayList<>();
        buttonRow2.add(new CallbackButton(
                CallbackName.EVENTS.getCallbackName() + ":0", StringConstants.EVENTS_BUTTON.getValue()));
        buttonRow2.add(new CallbackButton(
