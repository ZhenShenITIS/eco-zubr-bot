...
@Component
public class TasksCallback implements Callback {
    private final CallbackName callbackName = CallbackName.TASKS;

    @Override
    public void handleMessageCallback(MessageCallbackUpdate update, MaxClient client) {
        NewMessageBody replyMessage =
                NewMessageBodyBuilder.ofText("Здесь раздел с заданиями").build();
